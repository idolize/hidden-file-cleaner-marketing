    ...
    <div className="min-h-screen">
      ...
      <header className="bg-[rgb(var(--section-alt))] border-b border-[rgb(var(--gray-200))] py-12">
        <div className="container mx-auto px-6">
          ...
          <h1 className="text-3xl font-bold text-[rgb(var(--foreground-rgb))]">Privacy Policy</h1>
          <p className="mt-2 text-[rgb(var(--gray-600))]">Last updated: April 4, 2024</p>
        </div>
      </header>
      ...
      <div className="container mx-auto px-6 py-12 max-w-3xl">
        <article className="prose prose-slate max-w-none dark:prose-invert">
          <h2>Introduction</h2>
          <p>
            Welcome to Hidden File Cleaner. This Privacy Policy explains how we collect, use, and protect your
          ...
          <h2>Data Storage</h2>
          <p>
            All file operations are performed locally on your device. We do not store or transmit your files to any
            external servers.
          </p>
